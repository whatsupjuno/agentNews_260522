  ...
  return (
    <div style={{
      ...
      <div style={{ height: 'calc(100% - 56px)', overflowY: 'auto', paddingBottom: 30 }}>
        ...
        {/* "콘텐츠" group 전체 제거 (MVP) —
            잠금 코드 / 잠금 해제 도움말 / 구독자 관리 / 구독자 해제 모두 DB 직접 관리.
            앱 내 노출 없음. ARM 만으로 모드 전환. */}
...
// iOS-style toggle row — used for 전환 모드
function ToggleRow({ icon, iconBg, label, sublabel, value, onToggle, last }) {
  return (
    <div onClick={onToggle} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: '#fff',
          boxShadow: '0 2px 4px rgba(0,0,0,0.16), 0 0 1px rgba(0,0,0,0.1)',
